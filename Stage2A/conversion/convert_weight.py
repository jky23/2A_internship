...
@author: jky Code source from from https://github.com/pierluigiferrari/caffe_weight_converter
"""
...
#model = open('model_iter_80000.caffemodel', 'rb')
def convert_caffemodel_to_dict(prototxt_filename,caffemodel_filename,out_path=None,verbose=False):
