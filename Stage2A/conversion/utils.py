...
layer_num_to_name = {  # Maps layer number to names.
    0: 'NONE',
    1: 'ACCURACY',
    2: 'BNLL',
    3: 'CONCAT',
    ...
    for l in range(nb_layers):
        ...
        if included:
            ...
            if layer_key not in network:
                network[layer_key] = []
            top_blobs = (list(map(str, layers[l].top)))
            bottom_blobs = (list(map(str, layers[l].bottom)))
...
def is_data_input(layer):
    """Checks if the layer is an input layer
    """
