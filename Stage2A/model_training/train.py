...
writer = SummaryWriter('data/result')
...
if __name__ == '__main__':
	...
	parser.add_argument('--hosts', type=list, default=['algo_1'])
	parser.add_argument('--current-host', type=str, default='algo_1')
	parser.add_argument('--model-dir', type=str, default='data/result/')
	parser.add_argument('--train-dir', type=str, default='data/train1/')
	parser.add_argument('--test-dir', type=str, default='data/val/')
