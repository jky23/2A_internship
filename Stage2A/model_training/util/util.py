...
def intersectionAndUnion(output, target, K, ignore_index=255):
    ...
    output = output.reshape(output.size()).clone()
...
def pytorch_iou(y_true,y_pred,num_classes=9):
    '''
    ...
    '''
    return iou(y_true,y_pred,num_classes=num_classes).item()
    
def pytorch_f1(y_true,y_pred):
    '''
